...
//Rellenos de los selects tienda y roles
            ...
            <div class="form-group">
                ...
                <select id="crear-idrol" name="idrol" required>
                    ...
                    foreach ($lista_rolesfull as $rolfull): ?>
                        <option value="<?php echo htmlspecialchars($rolfull['idrol']); ?>" <?php echo (isset($usuario) && $usuario['idrol'] == $rolfull['idrol']) ? 'selected' : ''; ?>>
                            <?php echo htmlspecialchars($rolfull['nomrol']); ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            </div>
